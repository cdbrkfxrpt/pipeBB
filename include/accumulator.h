...
#ifndef SCRUBB_CORE_ACCUMULATOR_H_
#define SCRUBB_CORE_ACCUMULATOR_H_
 ...
 * the `accumulator` class. However, in longer code segments using scruBB
...
#endif  // SCRUBB_CORE_ACCUMULATOR_H_
